...
3. Add a project file called 'sql/each_table_named.sql' __(NAME MUST BE EXACT, OR ELSE VARIABLES CHANGED IN THE WORKFLOW REFERENCE)__ and paste the following query into the file:
